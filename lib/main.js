...
(function() {
  ...
  this.find_repetitions = function(text) {
    ...
    R.sort(function(a, b) {
      var a_area, a_count, a_coverage, a_length, b_area, b_count, b_coverage, b_length;
      a_coverage = a.coverage, a_area = a.area, a_count = a.count, a_length = a.length;
      b_coverage = b.coverage, b_area = b.area, b_count = b.count, b_length = b.length;
